 ...
 * @author patri_000
 */
public class VariablesSelectionPanel extends javax.swing.JPanel {

    private MainController controller;
    
    public VariablesSelectionPanel() {
        initComponents();
    ...
    private void btnContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinueActionPerformed
        if(this.cmbMPCode.getSelectedItem() == this.cmbUpdateDate.getSelectedItem()) {
            ...
            this.controller.processDatabase(this.cmbUpdateDate.getSelectedItem(), 
