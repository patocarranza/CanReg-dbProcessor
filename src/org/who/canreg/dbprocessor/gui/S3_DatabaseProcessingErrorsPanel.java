 ...
 * @author patri_000
 */
public class S3_DatabaseProcessingErrorsPanel extends javax.swing.JPanel {

    private S3_DatabaseProcessorController controller;
    
    public S3_DatabaseProcessingErrorsPanel() {
        initComponents();  
        this.refresh();
    }
    
    public void setDatabaseProcessorController(S3_DatabaseProcessorController controller) {
