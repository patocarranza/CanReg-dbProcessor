...
import org.who.canreg.dbprocessor.gui.DatabaseProcessingErrorsPanel;
 ...
 * @author patri_000
 */
public class DatabaseProcessorController implements LongProcessStrategy {
    
    private DatabaseProcessingErrorsPanel guiPanel;
    private MainController controller;
    private ArrayList<String> headers;    
    private String[][] dataValues = null; 
    
    public DatabaseProcessorController(DatabaseProcessingErrorsPanel guiPanel) {
    ...
    public void btnContinueAction() {
        if(this.headers.size() > 0) {            
            ...
            if(result == JOptionPane.OK_OPTION) {
                this.controller.databaseProcessingCompleted();
            }
        } else
            this.controller.databaseProcessingCompleted();
    }
