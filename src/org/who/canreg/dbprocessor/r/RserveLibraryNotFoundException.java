...
/**
 * Rserve library (in the R environment) was not found.
 * @author Patricio Carranza, Beatriz Carballo
 * @version 0.1.1
 * Date: 07/07/2014
 */
public class RserveLibraryNotFoundException extends Exception {
    
    private String originalMessage;
    
    public RserveLibraryNotFoundException(String msg) {
